...
# Run 5ps heating
$AMBERHOME/bin/sander -O -i heat.i -p ../$sys.top -c ../struct/min_sa_$sys.rst -o heat_$sys.log -r heat_$sys.rst -x heat_$sys.mdcrd
# Run short md production (100ps default)
$AMBERHOME/bin/sander -O -i md.i -p ../$sys.top -c heat_$sys.rst -o md_$sys.log -r md_$sys.rst -x md_$sys.mdcrd
